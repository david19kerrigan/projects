...
public static void main(String[] args) {
  ...
  try {
        ...
        System.out.println(generateTOTP("david19kerrigan@gmail.comHDECHALLENGE003", steps, "10",
        "HmacSHA512"));
...
public static String getKey() {
    ...
    try {
          ...
          String fmtTime = String.format("%1$-11s", System.currentTimeMillis());
          String utcTime = df.format(date);
          return (generateTOTP("david19kerrigan@gmail.comHDECHALLENGE003", steps, "10",
          "HmacSHA512"));
